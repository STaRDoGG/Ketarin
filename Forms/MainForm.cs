    ...
    public partial class MainForm : PersistentForm
    {
        ...
        public MainForm()
        {
            ...
            colStatus.AspectToStringConverter = delegate(object x)
            {
                ...
                {
                    // TODO: Switch these to icons and tooltips?
        ...
        private void UpdateList()
        {
            ...
            try
            {
                ...
                if (m_Jobs.Length > 0)
                {
                    olvJobs.EmptyListMsg = "Loading apps ...";
        ...
        /// <summary>
        /// Updates all items, using the same order as the items in the list (considers sorting).
        /// </summary>
